...
const Description = () => {
    return (
        <section>
        <div className="grid max-w-screen-2xl px-4 py-6 mx-auto lg:gap-4 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div className="mr-auto place-self-center lg:col-span-7">
            <h1 className="max-w-3xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl text-white">Personal Coaching</h1>
            <p className="max-w-3xl mb-6 font-base text-gray-200 lg:mb-8 md:text-xl lg:text-2xl">
