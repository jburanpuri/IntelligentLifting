...
const Checklist = () => {
	return (
		<section>
			<div className="container flex flex-col-reverse mx-auto lg:flex-row py-10">
				<div className="flex flex-col px-6 py-24 space-y-12 rounded-sm sm:p-8 lg:p-12 lg:w-1/2 xl:w-1/2 text-white">
					<h1 className="text-4xl font-extrabold tracking-tight md:text-5xl xl:text-6xl text-white">Coaching Made Simple</h1>
					...
					<a href="#buy" className="inline-flex justify-center items-center py-2 px-2 text-3xl font-2xl text-center text-black rounded-lg bg-primary hover:bg-white focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
						Buy Now
					</a>
				</div>
